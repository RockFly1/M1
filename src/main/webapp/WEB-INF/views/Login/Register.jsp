        ...
        <div class="box">
            <div class="content-wrap">
                ...
                <form action="<%=basePath%>/Login/ru" method="post">
	                ...
	                <input class="form-control" type="password" id="userPassword" name="userPassword"  placeholder="密码">
	                <input class="form-control" type="text" id="userGender" name="userGender"   placeholder="邮箱">
